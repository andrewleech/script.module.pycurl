...
# Original from: https://pypi.python.org/pypi/human_curl/0.13
...
binary_package_name = "%s-%s.%s-py%s.exe" % (package, version, plat_name, target_version)
...
if not binary_package_path or not os.path.exists(binary_package_path):
    ...
    if binary_package_path not in sys.path:
        sys.path.append(binary_package_path)
